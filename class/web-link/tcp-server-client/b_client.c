...
int main(int argc,char **argv)
{
    ...
    my_net.sin_addr.s_addr=inet_addr(B_CLIENT_IP);
    my_net.sin_port=htons(B_CLIENT_PORT);
    ...
    aim_net.sin_addr.s_addr=inet_addr(A_CLIENT_IP);
    aim_net.sin_port=htons(A_CLIENT_PORT);
